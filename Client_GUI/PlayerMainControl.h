...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label2->Location = System::Drawing::Point(380, 39);
			...
			this->label3->Location = System::Drawing::Point(551, 39);
			...
			this->countLabel->Location = System::Drawing::Point(730, 39);
			...
			this->groupBox1->Location = System::Drawing::Point(93, 86);
			...
			// startButton
			// 
			this->startButton->Location = System::Drawing::Point(121, 87);
			this->startButton->Name = L"startButton";
			this->startButton->Size = System::Drawing::Size(218, 83);
			...
			this->viewQuestionLabel->Location = System::Drawing::Point(89, 466);
			...
			this->viewQuestionLabel->TabIndex = 4;
			this->viewQuestionLabel->TabStop = true;
			this->viewQuestionLabel->Text = L"View All Questions";
			this->viewQuestionLabel->LinkClicked += gcnew System::Windows::Forms::LinkLabelLinkClickedEventHandler(this, &PlayerMainControl::ViewQuestionLabel_LinkClicked);
			// 
			// PlayerMainControl
			// 
...
#pragma endregion
	...
	private: System::Void ViewQuestionLabel_LinkClicked(System::Object^ sender, System::Windows::Forms::LinkLabelLinkClickedEventArgs^ e) {
		auto thread = gcnew Threading::Thread(gcnew Threading::ThreadStart(this, &PlayerMainControl::fetchQuestionList));
		thread->Start();
	}
	...
	private: void fetchQuestionList() {
		auto finish = gcnew finishFetchDelegate(this, &PlayerMainControl::finishFetch);
